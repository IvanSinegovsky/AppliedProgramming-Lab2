package bsu.rfe.java.group7.lab2.Sinegovsky.varA6;
...
// как компонент, совместно используемый в различных методах
    ...
    public Double calculate1(Double x, Double y, Double z) {
        ...
        return (Math.pow((Math.cos(Math.exp(y)) + Math.exp(y * y) + Math.sqrt(1 / x)), 0.25)
    ...
    public Double calculate2(Double x, Double y, Double z) {
        ...
        return ((1 + Math.pow(x, z) + Math.log(y * y)) / (Math.sqrt(x * x * x + 1)));
    }
